...
class CountPageTest extends TestCase
{
     ...
     */
    public function testCountPage(array $airports, int $expectedPage): void
    {
        $this->assertEquals($expectedPage, countPage($airports));
    }
